...
const component = `<div id="rec2088597551" class="clean-header-block"><div id="vf-header-root"></div><link rel="stylesheet" href="../components/header.css"><script src="../components/header.js" defer></script></div> `;
