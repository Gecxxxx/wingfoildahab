    ...
    <section class="dahab-section">
      ...
      <div class="dahab-wrapper">
        ...
        <div class="dahab-info">
          ...
          <p>У нас три спасательных катера, и мы предоставляем спасательный телефон для выходов на волны в зону открытого моря.</p>
          ...
          <p>Наша станция «Ветратория» – первый официально лицензированная станция вингфойлинга в Египте, Синай.<br>Мы также являемся официальным тест-центром оборудования <b>RRD</b>.</p>
          <div class="dahab-divider"></div>
          ...
          <div class="dahab-actions">
            ...
            <a href="#" class="dahab-btn dahab-btn--fill" data-scroll=".uc-form">Контакты</a>
          </div>
        </div>
      </div>
    </section>
