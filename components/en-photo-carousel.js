(() => {
  const mount = document.getElementById('vf-en-photo-carousel-root');
  if (!mount) return;

  const root = new URL('../', document.currentScript.src);
  const asset = (name) => new URL(`assets/carousel/${name}`, root).href;
  const images = ['slide-01.webp', 'slide-02.webp', 'slide-03.webp', 'slide-04.webp', 'slide-05.webp', 'slide-06.webp'];
