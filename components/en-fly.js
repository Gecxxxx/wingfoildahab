(() => {
  ...
  const features = [
    ['boat.png', 'Boat', 'Instructor with a boat', 'Use the boat during the lessons. We will start in the most suitable windward part of the water.'],
    ['radios.png', 'Radios', "BB-Talkin' Radios", "We use professional BB-Talkin' radios in training for easy real-time communication with the instructor."],
    ['safety.png', 'Safety', 'Water Practice', 'Under close supervision, you can easily master wingfoiling. You will be looked after by 4 rescue boats.'],
    ['gift.png', 'Gift', '1 Hour Rental Gift', 'After your first Sup+Wing lesson, you will receive 1 hour of equipment rental as a gift.'],
  ];
