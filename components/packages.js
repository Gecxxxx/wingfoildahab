(() => {
  ...
  mount.innerHTML=`<section class="wing-packages uc-wing-packages"><div class="packages-wrap"><h2>Пакеты <span class="packages-orange">обучения</span></h2>${tabs('packages-tabs--primary')}<div class="packages-grid"></div></div><div class="package-modal" role="dialog" aria-modal="true"><div class="package-modal-content"><button class="package-modal-close" type="button" aria-label="Закрыть">×</button><div class="package-modal-info"><h3></h3><p>Профессиональный курс обучения на нашей станции в Дахабе. Мы предоставляем современное оборудование RRD и услуги сертифицированных инструкторов.</p><ul class="package-modal-list"></ul><button class="package-btn package-primary package-modal-book" type="button">Забронировать</button></div><div class="package-modal-image"></div></div></div></section>`;
