(() => {
  ...
  const data={
    lessons:[
      ['3 дня',270,30,'Старт',['3 часа с инструктором','45 мин катер + фойл','Оборудование включено'],'lessons-03.jpg'],
      ['4 дня',360,40,'Базовый+',['4 часа с инструктором','60 мин катер + фойл','Оборудование включено'],'lessons-04.jpg'],
      ['5 дней',420,50,'Популярный',['5 часов с инструктором','60 мин катер + фойл','Оборудование включено'],'lessons-05.jpg'],
      ['6 дней',480,60,'Прогресс',['6 часов с инструктором','60 мин катер + фойл','Оборудование включено'],'lessons-06.jpg'],
      ['7 дней',540,70,'Максимум',['7 часов с инструктором','60 мин катер + фойл','Оборудование включено'],'lessons-07.jpg']
    ],
    intensive:[
      ['1 день',95,0,'Пробный',['1 час с инструктором','15 мин катер + фойл','Прокат SUP + Wing на день'],'intensive-01.jpg'],
      ['3 дня',350,205,'Интенсив',['3 часа с инструктором','45 мин катер + фойл','Прокат весь день','Страховка + Спасение'],'intensive-03.jpg'],
      ['4 дня',460,235,'Оптимальный',['4 часа с инструктором','60 мин катер + фойл','Прокат весь день','Страховка + Спасение'],'intensive-04.jpg'],
      ['5 дней',570,235,'Уверенный',['5 часов с инструктором','60 мин катер + фойл','Прокат весь день','Страховка + Спасение'],'intensive-05.jpg'],
      ['6 дней',670,235,'Мастер',['6 часов с инструктором','60 мин катер + фойл','Прокат весь день','Страховка + Спасение'],'intensive-06.png'],
      ['7 дней',780,240,'Профи',['7 часов с инструктором','60 мин катер + фойл','Прокат весь день','Страховка + Спасение'],'intensive-07.jpg']
    ]
  };
